...
function initialize_map() {
	...
	google.maps.event.addListener( marker, 'click', function() {
		...
		var content = '<div id="info" class="span6" style="height: 100px; width: 150px;"><strong>We are here</strong><p style="margin:0; padding:0">525 Northwood Rd,<br />West Palm Beach,<br />Florida 33407</a></p>' + '</div>';
